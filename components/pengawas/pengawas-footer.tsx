...
export function PengawasFooter() {
  ...
  return (
    <footer className="sticky bottom-0 z-30 border-t border-indigo-100 bg-white/80 px-4 py-2.5 text-slate-600 backdrop-blur md:bg-gradient-to-r md:from-indigo-50/95 md:via-white/95 md:to-blue-50/95 md:px-6 md:py-3 md:supports-[backdrop-filter]:bg-gradient-to-r md:supports-[backdrop-filter]:from-indigo-50/90 md:supports-[backdrop-filter]:via-white/90 md:supports-[backdrop-filter]:to-blue-50/90">
      <div className="pointer-events-none absolute inset-x-4 top-0 h-px bg-gradient-to-r from-transparent via-indigo-200 to-transparent md:inset-x-6" />
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <span className="text-slate-600">
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="font-medium text-indigo-600 hover:text-indigo-700 underline-offset-2 hover:underline transition-colors"
            >
              GARUDA-21.com
            </Link>{" "}
            Cloud Server
