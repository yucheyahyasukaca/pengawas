...
import { ChevronLeft, ChevronRight, Calendar, Plus, X, School, ChevronDown, Check, FileText, Clock } from "lucide-react";
              ...
              <>
                <div className="divide-y divide-slate-200">
                  ...
                  return (
                    <div
                      key={rencana.id}
                      className="border-b border-slate-200 py-2.5 hover:bg-slate-50/50 transition-colors last:border-b-0"
                    >
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div className="flex items-center gap-3 flex-wrap flex-1 min-w-0">
                            <div className="flex items-center gap-1.5 flex-shrink-0">
                              <Clock className="size-4 text-indigo-600 flex-shrink-0" />
                            ...
                            <div className="flex items-center gap-1.5 flex-shrink-0">
                              <School className="size-4 text-indigo-600 flex-shrink-0" />
                        ...
                        <div className="space-y-1.5 pl-6">
                          <div className="flex items-start gap-2">
                            <span className="text-xs font-semibold text-slate-500 uppercase flex-shrink-0 min-w-[100px]">
                              Indikator:
                            </span>
                            <p className="text-xs sm:text-sm font-semibold text-indigo-700 flex-1">
                            ...
                            <div className="flex items-start gap-2">
                              ...
                              <ul className="flex-1 space-y-1">
                                {rencana.penjelasan_implementasi.map((item, idx) => (
                                  item && (
                                    <li key={idx} className="text-xs sm:text-sm text-slate-600 flex items-start gap-1.5">
