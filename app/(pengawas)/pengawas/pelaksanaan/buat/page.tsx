  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Entri Kegiatan Baru</h1>
          <p className="text-sm text-slate-600 mt-1">
            Isi formulir untuk melakukan entri data pendampingan atau supervisi
          </p>
        </div>
      </div>
      ...
      <Card className="border border-indigo-200 bg-white shadow-md shadow-indigo-100/70">
        <CardHeader>
          <CardTitle className="text-slate-900 font-bold">Formulir Entri Kegiatan</CardTitle>
          <CardDescription className="text-slate-700">
            Lengkapi semua data yang diperlukan untuk kegiatan pendampingan atau supervisi
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="rounded-xl border border-indigo-100 bg-white p-8 text-center">
            <p className="text-sm text-slate-600 mb-4">
              Formulir input kegiatan akan dikembangkan lebih lanjut
            </p>
