...
export default function BuatLaporanTriwulanPage() {
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Buat Laporan Triwulan</h1>
          <p className="text-sm text-slate-600 mt-1">
            Isi formulir untuk membuat laporan triwulan sesuai format resmi
          </p>
        </div>
      </div>
        ...
        <CardContent>
          <div className="rounded-xl border border-indigo-100 bg-white p-8 text-center">
            <p className="text-sm text-slate-600 mb-4">
              Formulir input laporan triwulan akan dikembangkan lebih lanjut
            </p>
