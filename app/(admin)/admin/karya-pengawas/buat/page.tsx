          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <CardTitle className="text-xl font-bold text-slate-900">Buat Karya Pengawas</CardTitle>
                <CardDescription className="text-slate-600">
                  Tambahkan tulisan ilmiah, hasil penelitian, atau praktik baik pengawas
                </CardDescription>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <Card className="border border-rose-200 bg-white shadow-md shadow-rose-100/70">
              ...
              <CardContent className="space-y-4">
                ...
                {/* Submitted By (for supervisor uploads) */}
                <div className="space-y-2">
