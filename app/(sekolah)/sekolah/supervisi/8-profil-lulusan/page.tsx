...
import { ArrowLeft, UserCheck, Construction } from "lucide-react";

export default function DelapanProfilLulusanPage() {
      ...
      <Card className="border-0 bg-gradient-to-br from-green-50 via-emerald-50/80 to-teal-50/60 shadow-lg shadow-green-100/50">
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-2xl font-bold text-slate-900">8 Profil Lulusan</CardTitle>
