...
## Setup Tabel Rencana Program

Untuk membuat tabel `rencana_program` di Supabase, jalankan SQL berikut di Supabase SQL Editor:
...
2. Copy dan paste SQL di atas
3. Klik "Run" untuk menjalankan migration
4. Pastikan tabel `rencana_program` sudah dibuat dengan kolom yang sesuai
